...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-[85vh] grid md:grid-cols-[240px_1fr] bg-neutral-900/[0.02]">
        ...
        <div>
          <Link href="/" className="flex items-center gap-2 mb-8">
            ...
            <span className="font-display font-bold hidden md:block">
              19<span className="text-brand-gold">Store</span> <span className="text-xs font-normal text-white/40">Admin</span>
            </span>
          </Link>
