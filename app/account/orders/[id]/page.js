    ...
    <div className="max-w-3xl mx-auto px-4 md:px-6 py-10 animate-fadeIn">
            ...
            return (
              <div key={step} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {i < STEPS.length - 1 && <div className={`w-0.5 flex-1 min-h-[28px] ${done ? 'bg-brand-blue' : 'bg-white/10'}`} />}
                </div>
                <div className="pb-7">
      ...
      <div className="border border-white/10 rounded-2xl p-6 mb-8">
        ...
        <div className="flex justify-between text-sm mb-2">
          ...
          <span>{formatPKR(order.total - (order.deliveryFee || 0) + (order.discountAmount || 0))}</span>
        </div>
        <div className="flex justify-between text-sm mb-2">
