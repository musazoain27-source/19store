  ...
  if (loaded && items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center animate-fadeIn">
        <ShoppingBag size={56} className="mx-auto text-white/20 mb-6" />
    ...
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-10">
      ...
      <div className="grid md:grid-cols-[1fr_340px] gap-10">
        <div className="space-y-4">
          {items.map((item) => (
            <div key={item.key} className="flex gap-4 border border-white/10 rounded-2xl p-4 animate-fadeIn">
              <div className="relative w-24 h-28 rounded-xl overflow-hidden shrink-0 bg-white/5">
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div className="flex justify-between gap-2">
                  ...
                  <button
                    ...
                    className="text-white/30 hover:text-red-500 transition-colors h-fit"
        ...
        <div className="border border-white/10 rounded-2xl p-6 h-fit sticky top-24">
