...
export default function Footer() {
  return (
    <footer className="bg-[#f5f5f7] text-black mt-20 border-t border-black/5">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-14 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div className="col-span-2 md:col-span-1">
          ...
          <div className="flex gap-3 mt-4">
            <a href="#" className="text-black/60 hover:text-brand-blue transition-colors" aria-label="Instagram"><Instagram size={18} /></a>
            <a href="#" className="text-black/60 hover:text-brand-blue transition-colors" aria-label="Facebook"><Facebook size={18} /></a>
            <a href="#" className="text-black/60 hover:text-brand-blue transition-colors" aria-label="Twitter"><Twitter size={18} /></a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-black/60">
            <li><Link href="/category/Hoodies" className="hover:text-black transition-colors">Hoodies</Link></li>
            <li><Link href="/category/T-Shirts" className="hover:text-black transition-colors">T-Shirts</Link></li>
            <li><Link href="/category/Jackets" className="hover:text-black transition-colors">Jackets</Link></li>
            <li><Link href="/category/Bottoms" className="hover:text-black transition-colors">Bottoms</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-black/60">
            ...
            <li><Link href="/account/orders" className="hover:text-black transition-colors">Order History</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-black/60">
            ...
            <li><Link href="/admin/login" className="hover:text-black transition-colors">Admin</Link></li>
          </ul>
        </div>
      </div>
