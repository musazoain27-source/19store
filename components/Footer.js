...
export default function Footer() {
  return (
    <footer className="bg-black text-white mt-20 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-14 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div className="col-span-2 md:col-span-1">
          ...
          <div className="flex gap-3 mt-4">
            <a href="#" className="text-white/60 hover:text-brand-blue transition-colors" aria-label="Instagram"><Instagram size={18} /></a>
            <a href="#" className="text-white/60 hover:text-brand-blue transition-colors" aria-label="Facebook"><Facebook size={18} /></a>
            <a href="#" className="text-white/60 hover:text-brand-blue transition-colors" aria-label="Twitter"><Twitter size={18} /></a>
          </div>
        </div>
